...
// UUID v1: Baseado em carimbo de tempo e endereço MAC.
// UUID v3: Baseado em um hash MD5 de um nome e namespace.
// UUID v4: Gerado aleatoriamente.
// UUID v5: Baseado em um hash SHA-1 de um nome e namespace.
import { v4 as uuid } from 'uuid'; // (Universally Unique Identifiers)
